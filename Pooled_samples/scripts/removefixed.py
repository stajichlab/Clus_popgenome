...
newfilelungSNP = newfilename + "SNPONLY.lungonly.vcf"
newfilefixedSNP = newfilename + "SNPONLY.fixed.vcf"

newfilelungINDEL = newfilename + "INDELONLY.lungonly.vcf"
newfilefixedINDEL = newfilename + "INDELONLY.fixed.vcf"
