...
newfilelungSNP = newfilename + "SNPONLY.nofilter.lungonly.3per.vcf"
newfilefixedSNP = newfilename + "SNPONLY.nofilter.fixed.3per.vcf"

newfilelungINDEL = newfilename + "INDELONLY.nofilter.lungonly.3per.vcf"
newfilefixedINDEL = newfilename + "INDELONLY.nofilter.fixed.3per.vcf"
