...
covtable = subset(covtable,covtable$STRAIN_GROUP == "B")
#summary(covtable)
...
#+ scale_colour_brewer(palette = "Paired") 
   pdffile = sprintf("plot_CNV/genomewide_CNV_Bstrains_SC%d.pdf",i) 
   ...
   pdffile = sprintf("plot_CNV/genomewide_CNV_Bstrains_SC%d_%s.pdf",i,j)
   ggsave(pdffile,plot=p,width=10)
   }
}
